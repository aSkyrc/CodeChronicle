...
$filter = [
    'category' => 'Career and Networking' 
];
// Check if the user has the community in their interests
$communityName = 'Career and Networking'; // Example community name
...
// Fetch blog posts that match the filter and sort by 'createdAt' in descending order
...
<div class="community-category-visit" style="margin-top: 140px;">
    ...
    <div class="community-visit-img">
        <img src="../logos/community/careernetworking.jpg" width="500px" height="200px">
    </div>
                    ...
                    ?>
                        <div class="community-visit-blog-card">
                            ...
                            <div class="community-visit-card-body">
                                ...
                                <button class="community-visit-continue" onclick="location.href='communityVisitBlog.php?_id=<?php echo htmlspecialchars((string)$blog['_id']); ?>';">Continue reading...</button>
                            </div>
                        </div>
        ...
        <img class="blogging-image" src="../logos/bloggings.jpg" alt="Blogging">
            <div class="community-visit-top-blog">
                <div class="community-visit-blog-highlight">
                    <button onclick="location.href = 'communityPostBlog.php?community=Career%20and%20Networking';">Post</button>
                </div>
            </div>
        </div>
    </div>
