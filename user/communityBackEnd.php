...
$communityName = 'Backend Development'; // Example community name
...
<div class="community-category-visit" style="margin-top: 140px;">
    ...
    <div class="community-visit-img">
        <img src="../logos/community/backend.jpg" width="500px" height="200px">
    </div>
        ...
        <div class="community-visit-sidebar">
            ...
            <div class="community-visit-top-blog">
                <div class="community-visit-blog-highlight">
                    <button onclick="location.href = 'communityPostBlog.php?community=Backend%20Development';">Post</button>
                </div>
            </div>
        </div>
    </div>
