...
$communityName = 'Programming Language'; // Example community name
...
<div class="community-category-visit" style="margin-top: 140px;">
    ...
    <div class="community-visit-img">
        <img src="../logos/community/programminglanguages.jpg" width="500px" height="200px">
    </div>
        ...
        <img class="blogging-image" src="../logos/bloggings.jpg" alt="Blogging">
            <div class="community-visit-top-blog">
                <div class="community-visit-blog-highlight">
                    <button onclick="location.href = 'communityPostBlog.php?community=Programming%20Language';">Post</button>
                </div>
            </div>
        </div>
    </div>
